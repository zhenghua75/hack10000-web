...
return array(
    ...
    /* SESSION 和 COOKIE 配置 */
    'SESSION_PREFIX' => 'hack10000_home', //session前缀
    'COOKIE_PREFIX'  => 'hack10000_home_', // Cookie前缀 避免冲突
    ...
    'TMPL_EXCEPTION_FILE'   =>  APP_DEBUG ? MODULE_PATH.'View/default/Public/exception.html' : THINK_PATH.'Tpl/404.html',// 异常页面的模板文件
);
