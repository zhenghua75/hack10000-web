...
(function(){
    ...
    MagnifierF.prototype = {
        ...
        setEleFn: function(){
            ...
            var bigimgsrc=_is.mImgSrc;
            bigimgsrc=bigimgsrc.replace('560x420','org');
            _html1 = '<img style="width:100%;height:100%;" src="' + bigimgsrc + '">'
        ...
        specFn: function(){
            ...
            function TabFn(event){
                ...
                if (target.nodeName != "UL") {
                    ...
                    _oISrc = _oISrc.replace('96x72','560x420');
